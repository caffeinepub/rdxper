...
export class Backend implements backendInterface {
    ...
    async fetchBarGraphData(arg0: string, arg1: bigint): Promise<Array<BarGraphData>> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchBarGraphData(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async fetchTableData(arg0: string, arg1: bigint): Promise<Array<TableData>> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchTableData(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
